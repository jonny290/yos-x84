...
GLYPHSETS = {
    'ascii': {
        ...
        'bot-horiz': u'-', },
    'double': {
        'top-left': CP437TABLE[unichr(201)],
        'bot-left': CP437TABLE[unichr(200)],
        'top-right': CP437TABLE[unichr(187)],
        'bot-right': CP437TABLE[unichr(188)],
        'left-vert': CP437TABLE[unichr(186)],
        'right-vert': CP437TABLE[unichr(186)],
        'top-horiz': CP437TABLE[unichr(205)],
        'bot-horiz': CP437TABLE[unichr(205)],
    },
     'thin': {
...
class AnsiWindow(object):
    ...
    def dimensions(self):
        """
        Returns ysize,xsize,yloc,xloc.
        """
        return self._height, self._width, self._yloc, self._xloc
